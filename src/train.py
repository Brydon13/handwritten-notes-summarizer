...
sentences_txt_path = os.path.join("Datasets", "IAM_Sentences", "training", "ascii", "sentences.txt")
sentences_folder_path = os.path.join("Datasets", "IAM_Sentences", "training", "sentences")
